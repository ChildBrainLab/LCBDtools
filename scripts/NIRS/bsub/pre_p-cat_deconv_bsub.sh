...
bsub -J p-cat-deconv-$DATE -oo logs/pcat-nirs-deconv-$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/NIRS/bsub/p-cat_deconv_bsub.sh
