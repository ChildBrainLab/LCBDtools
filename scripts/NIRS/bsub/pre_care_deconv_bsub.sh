...
bsub -J care-nirs-deconv-$DATE -oo logs/care-deconv-$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/NIRS/bsub/care_deconv_bsub.sh
