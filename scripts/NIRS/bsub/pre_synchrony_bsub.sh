...
bsub -J synchrony-$DATE -oo logs/synchrony/synchrony_$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/NIRS/bsub/CARE_synchrony_bsub.sh
