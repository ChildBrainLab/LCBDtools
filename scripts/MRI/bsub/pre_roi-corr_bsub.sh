...
bsub -J fmri-roi-$DATE -oo logs/analysis/roi-corr-$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/MRI/bsub/roi-corr_bsub.sh
