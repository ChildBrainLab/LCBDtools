...
bsub -J deconv-$DATE -oo logs/deconv/deconv-$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/MRI/bsub/deconv_bsub.sh
