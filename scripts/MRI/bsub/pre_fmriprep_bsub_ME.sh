...
export OUTPUT_DIR=${STORAGE_ALLOCATION}moochie/analysis/CARE/ME_fMRIPrep_data/
...
bsub -J $SUBJECT-$SESSION-fmriprep-ME -oo logs/fmriprep/$SUBJECT-$SESSION-fmriprep-ME.log -g /$USER/preprocessing < fmriprep_bsub_ME.sh
