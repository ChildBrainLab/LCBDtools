...
export BOLDNET_DIR="/storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/script/MRI/boldnet/"
...
bsub -J abcd-BOLDnet-$DATE -oo $BOLDNET_DIR/logs/abcd_BOLDnet_$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/MRI/bsub/abcd_boldnet_bsub.sh
