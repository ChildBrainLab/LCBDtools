...
bsub -J cnda-sync-$DATE -oo logs/cnda/cnda-sync-$DATE.log -g /$USER/preprocessing < /storage1/fs1/perlmansusan/Active/moochie/github/LCBDtools/scripts/MRI/bsub/cnda_bsub.sh
