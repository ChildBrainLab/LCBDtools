...
% NirsPaths = dir(fullfile(path, '**', '*.nirs'));
...
%     raw(i) = nirs.io.loadDirectory(NirsPaths(i).folder, {'session', 'visit', 'subject'}, 'nirs.io.loadDotNirs', '.nirs');
% end
raw = nirs.io.loadDirectory(path, {'session', 'visit', 'subject'}, 'nirs.io.loadDotNirs', '.nirs');
%%
