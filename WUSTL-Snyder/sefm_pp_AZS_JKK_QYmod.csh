...
set mcvbin = /data/nil-bluearc/hershey/unix/software/MRIConvert/MRIConvert-2.1.0/usr/bin
...
# kenleyj added for ind sefm input
if (${#argv} > 2) then
	set sefm = ($3 $4)
	echo ""
	echo "These are your sefm study nums "$sefm
	echo ""
endif
